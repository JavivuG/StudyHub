...
function toggleDeleteModal(info,url) {
    ...
    modal.innerHTML = '<div class="warning-header" id="warning-header"><h3><i class="fa fa-exclamation-circle" aria-hidden="true"></i>  Confirmar borrado</h3><span data-confirm=0 class="modal-action-delete" id="warning-close"><i class="fa fa-times" aria-hidden="true"></i></span></div><div id="warning-content"><p>' + text + '</p></div><div id="warning-buttons"><button class="modal-action-delete" data-confirm=0 id="warning-button-no">No</button><button class="modal-action-delete" data-confirm=1 id="warning-button-yes">Sí</button></div>';
