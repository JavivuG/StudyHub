    ...
    <body>
        ...
        <div class="container">
            <ul class="page-title-container">
                ...
                <li>
                    <span class="page-title">Mis ficheros</span>
                </li>
            </ul>
        </div>
        ...
        <div class="container">
            <ul class="nav-bar">
                ...
                <li>
                    <span class="items-nav"><a href="profile.jsp">Perfil</a></span>
                </li>
                <li>
                    <img src="images/arrow.svg" alt="Arrow" id="arrow" />
                </li>
                <li>
                    <span class="items-nav"><a href="#">Mis ficheros</a></span>
                </li>
            </ul>
        </div>
        ...
        <div class="container-principal">
            <div class="title-fich">
                <div class="my_files">
                    ...
                    <% ArrayList<Fichero> listaFicheros = (ArrayList<Fichero>) session.getAttribute("mis_ficheros"); %>
                    <h2>Mis ficheros</h2>
                    <% int tamano=listaFicheros.size();
                        if (tamano==0){ %>
                            <p>No has subido ningún ficheros todavía<p>
                        <% }
                        else { %>
                            <p>Has subido <%=tamano%> ficheros<p>
                        <% } %>
                </div>
            </div>
