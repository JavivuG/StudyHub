...
<html lang="es">
    ...
    <body>
            ...
            <ul class="nav-bar">
                ...
                <li>
                    ...
                    <span class="items-nav"
                          ><a href="forum.jsp?idForo=">a</a></span
                    >
                </li>
                <li>
                    <img src="images/arrow.svg" alt="Arrow" id="arrow" />
                ...
                <li>
                    <span class="items-nav"><a href="files.jsp">Ficheros</a></span>
                </li>
                <li>
                    <img src="images/arrow.svg" alt="Arrow" id="arrow" />
                </li>
        ...
        <div class="container-principal">
            ...
            <form method="post" action="uploaded.jsp" enctype="multipart/form-data"   >
                <label for="docInput" class="custom-file-upload">
                    Selecciona un fichero
                </label>

                <input accept=".pdf, .txt, .doc, .docx, image/*" type='file' id="docInput" class="button" />
