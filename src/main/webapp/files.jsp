    ...
    <body>
        ...
        <div class="container">
            <ul class="nav-bar">
                ...
                <li>
                    <span class="items-nav"><a href="index.jsp">Inicio</a></span>
                </li>
                <li>
                ...
                <li>
                    <span class="items-nav"><a href="#">Ficheros</a></span>
                </li>
            </ul>
        </div>
                        ...
                        <div class="fichero">
                            <div class="ag-courses_content">
                                <div class="ag-courses-item_flex">
                                    ...
                                    <a href="/downloadServlet?idFichero=<%= ficheroActual.getId_fichero()%>&page=files"><img src="images/download.svg" alt="Descargar" class="img-download"/></a>
                                </div>
                            </div>
                                    <% if (request.isUserInRole("moderador") || request.isUserInRole("administrador") || ficheroActual.getNickname().equals(UserInfo.getUserNickname(request))){ %>         
                        <div class="borrar-tema">
                                <button class="borrar-button" id="delete-button" data-info="files" data-url="/DeleteFile?idFichero=<%= ficheroActual.getId_fichero()%>&idForo=<%= ficheroActual.getId_foro()%>&idComentario=<%= ficheroActual.getId_comentario()%>&page=my_files"><i class="fa-solid fa-trash-can"></i></button>
                        </div>
                        <% } %>
                        </div>
        ...
        <script>
            Swal.fire({
                title: '¡Gracias!',
                text: 'Subida realizada con éxito.',
                footer: '¡Gracias por contribuir con <b>StudyHub</b>!',
                icon: 'success',
                timer: 3000,
